...
organization = "nwxyb9" # repalce it with organization ID
deviceType = "IOTsample" #replace it with device type
deviceId = "SmartDevice" #repalce with device id
authMethod = "token"
authToken = "sachin10"#repalce with token
